...
import { DisabilityCategory, UserProfile, AssistiveDevice, MedicalService, LivelihoodProgram, ProgramAvailment } from '@/Providers/AlagaLink/types';
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-alaga-navy text-gray-900 dark:text-white transition-colors duration-500 overflow-x-hidden">
      {/* FRAME 1: Introduction Hero */}
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center p-6 text-center overflow-hidden bg-white dark:bg-alaga-navy">
        ...
        <div className="relative z-10 max-w-3xl space-y-8 animate-in fade-in zoom-in-95 duration-1000">
      ...
      {/* FRAME 2: Services & Features */}
      <section className="relative min-h-screen flex flex-col items-center justify-center p-6 text-center overflow-hidden bg-alaga-gray dark:bg-alaga-navy/60">
        <div className="relative z-10 max-w-5xl w-full space-y-12 animate-in fade-in zoom-in-95 duration-1000">
           {/* Hero Image */}
           <div className="w-full">
             <div className="relative rounded-[32px] overflow-hidden shadow-2xl">
               <Image
                 src="https://images.unsplash.com/photo-1559027615-cd2628902d4a?w=1200&h=600&fit=crop"
                 alt="Community Support & Digital Connectivity"
                 width={1200}
                 height={600}
      ...
      {/* FRAME 3: Community Vigilance */}
      <section id="community-vigil" ref={missingRef} className="min-h-screen py-32 px-6 relative overflow-hidden bg-white dark:bg-alaga-navy/80">
        <div className="absolute top-0 right-0 w-full h-1/2 pointer-events-none opacity-10">
          <div className="absolute top-1/4 right-1/4 w-80 h-80 bg-red-500 rounded-full blur-3xl"></div>
        </div>

        <div className="max-w-5xl mx-auto relative z-10 space-y-12 animate-in fade-in zoom-in-95 duration-1000">
          {/* Section Header */}
          <div className="text-center space-y-4 mb-16">
            <div className="flex justify-center gap-2">
              <div className="w-12 h-12 bg-red-500/10 text-red-500 rounded-2xl flex items-center justify-center">
                <i className="fa-solid fa-person-circle-question text-2xl"></i>
              </div>
            </div>
            <h2 className="text-5xl md:text-7xl font-black text-3d-heavy">Community Vigilance</h2>
            <p className="text-sm font-black uppercase tracking-[0.3em] opacity-30">Lost & Found Recovery System</p>
            <p className="text-lg font-medium opacity-60 leading-relaxed max-w-3xl mx-auto">Our advanced community alert system links registry data to rapid incident reporting, helping PDAO and MSWDO coordinate faster recovery for missing persons.</p>
          </div>

          {/* Carousel Component */}
          <div className="w-full rounded-[32px] overflow-hidden shadow-2xl">
            {/* Placeholder for CommunityVigilCarousel component - would be imported and used here */}
            <div className="bg-gradient-to-br from-red-500/5 to-red-500/10 p-8 rounded-[32px] text-center">
              <p className="text-opacity-60 font-medium">Missing Persons & Found Persons Carousel</p>
            </div>
          </div>

          {/* CTA */}
          <div className="text-center">
            <button onClick={() => scrollTo(joinRef)} className="px-10 py-5 border-2 border-red-500 text-red-500 rounded-[24px] font-black text-sm uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all shadow-xl">
              Explore Safety Portal
            </button>
          </div>
        </div>
      </section>

      {/* FRAME 4: Programs & Services */}
      <section id="programs" className="min-h-screen py-32 px-6 bg-alaga-gray dark:bg-alaga-navy/40 relative overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="text-center space-y-4">
            <h2 className="text-5xl md:text-7xl font-black text-3d">Programs & Services</h2>
      ...
      <section id="community-vigil" ref={missingRef} className="min-h-screen py-32 px-6 relative overflow-hidden bg-white dark:bg-alaga-navy/80">
        ...
        <div className="max-w-5xl mx-auto relative z-10 space-y-12 animate-in fade-in zoom-in-95 duration-1000">
          ...
          {/* Carousel Component - Insert CommunityVigilCarousel here */}
          <div className="w-full rounded-[32px] overflow-hidden shadow-2xl">
            <div className="bg-gradient-to-br from-red-500/5 to-red-500/10 p-8 rounded-[32px] text-center">
              <p className="text-opacity-60 font-medium">Missing Persons & Found Persons Carousel</p>
            </div>
      ...
      {/* FRAME 5: Login/Registration Section */}
